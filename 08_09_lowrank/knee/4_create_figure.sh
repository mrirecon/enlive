...
scale_and_text "../"${NLINV}"/r_mm_${US}.png" "ENLIVE" 2m.png 
...
scale_and_text ../${NLINV}/r_mmu_${US}_map_0000.png "map #1" m0.png 
scale_and_text ../${NLINV}/r_mmu_${US}_map_0001.png "map #2" m1.png 
